...
async def add_product_image(name: str, category_id: int, file: UploadFile):
    im_path = f"app/static/images/products/{name}_{category_id}.webp"
...
async def rename_product_image_file(
    ...
    old_path = f"app/static/images/products/{old_name}_{old_category}.webp"
    new_path = f"app/static/images/products/{new_name}_{new_category}.webp"
...
async def add_product_item_image(SKU, product_id: UUID, file: UploadFile):
    im_path = f"app/static/images/products/items/{SKU}_{product_id}.webp"
...
async def rename_product_item_image_file(
    ...
    old_path = f"app/static/images/products/items/{old_SKU}_{old_product}.webp"
    new_path = f"app/static/images/products/items/{new_SKU}_{new_product}.webp"
...
async def add_profile_image(name: str, file: UploadFile):
    im_path = f"app/static/images/user_profiles/{name}"
...
async def delete_profile_image_file(name: str):
    im_path = f"app/static/images/user_profiles/{name}.webp"
