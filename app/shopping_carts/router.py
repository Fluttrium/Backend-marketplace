...
from app.shopping_carts.schemas import (
    SShoppingCart,
    SShoppingCartCreate,
    SShoppingCarts,
)
...
async def get_all_shopping_carts(user: Users = Depends(get_current_user)):
